...
class Ui_PlayblasterWidget(object):
    def setupUi(self, PlayblasterWidget):
        ...
        PlayblasterWidget.resize(1324, 831)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.playblastButton.setFont(font)
        ...
        self.setCameraButton.setFont(font2)
        ...
        self.ayonEndLineEdit.setFont(font1)
        ...
        self.ayonStartLineEdit.setFont(font1)
        ...
        self.ayonShotNameLineEdit.setFont(font1)
        ...
        self.ayonResolutionWidthLineEdit.setFont(font1)
        ...
        self.ayonResolutionHeightLineEdit.setFont(font1)
        ...
        self.playblastVideoFolderLineEdit.setFont(font2)
        ...
        self.setPlayblastVideoFolderButton.setFont(font2)
        ...
        self.videoFileNameLineEdit.setFont(font2)
        ...
        font3.setBold(True)
        font3.setWeight(75)
        self.playblastEndLineEdit.setFont(font3)
        ...
        self.playblastStartLineEdit.setFont(font3)
        ...
        font4.setBold(False)
        font4.setWeight(50)
        self.updateTimesFromAyonButton.setFont(font4)
        ...
        self.updateTimesFromMayaButton.setFont(font4)

        self.gridLayout_5.addWidget(self.updateTimesFromMayaButton, 2, 3, 1, 2)


        self.gridLayout_4.addWidget(self.groupBox_3, 8, 0, 1, 1)
        ...
        self.uploadToShotgridButton = QPushButton(self.groupBox_9)
        self.uploadToShotgridButton.setObjectName(u"uploadToShotgridButton")
        font5 = QFont()
        font5.setPointSize(8)
        font5.setBold(True)
        font5.setWeight(75)
        self.uploadToShotgridButton.setFont(font5)

        self.gridLayout_10.addWidget(self.uploadToShotgridButton, 0, 0, 1, 1)


        self.gridLayout_4.addWidget(self.groupBox_9, 2, 0, 1, 1)
        ...
        self.setCommentToSceneButton.setFont(font2)
        ...
        self.gridLayout_4.addWidget(self.groupBox_4, 7, 0, 1, 1)
        ...
        self.uploadToShotgridButton.clicked.connect(PlayblasterWidget.launchUploadTool)
...
"Maya Timeline", None))
        self.groupBox_9.setTitle(QCoreApplication.translate("PlayblasterWidget", u"Shotgrid Upload", None))
        self.uploadToShotgridButton.setText(QCoreApplication.translate("PlayblasterWidget", u"Launch Shotgrid Upload", None))
