...
class InventoryModel(TreeModel):
    ...
    def refresh(self, selected=None, containers=None):
        ...
        if containers is None:
            #TODO: Fix this to call UPDATE SELECTED
            print("why is this calleD?")
            print("self._controller",self._controller)
            print("method ... self._controller.get_containers",self._controller.get_containers)
            containers = self._controller.get_containers(selected=True)
